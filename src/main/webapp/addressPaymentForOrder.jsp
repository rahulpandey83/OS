...
<div class="right-div">
<h3>Enter country</h3>
<input class="input-style" type="text" name="country" value="<%=rs2.getString(5)%>" placeholder="Enter Country" required>
</div>
...
<div class="right-div">
<h3>Pay online on mypay@.com</h3>
<input class="input-style" type="text" name="transactionId"  placeholder="Enter Trasaction ID" >
